...
3) Access the `workbench` named `chatbot-rolling-20250408-notebook`
...
5) In the terminal, run `cd chatbot-rolling-20250408` to navigate to your sample app's directory
